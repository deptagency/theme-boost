          ...
          <div>
            <div className="o-television is-active">
              ...
              <div className="o-television__display">
                <section>
                  <label for="" className="c-title-level-4">Größe</label>
                ...
                <div className="o-television__display__boundless">
                  <span className="c-divider c-divider--break o-distance-m"></span>
                </div>
                <section className='o-distance-m'>
                  <label for="" className="c-title-level-4">Farbe</label>
                ...
                <section className="o-distance-m">
                  <label for="sel-brand" className="c-title-level-4">Marke</label>
