        ...
        return (<div>
          <div className="c-gallery">
            <div className="c-gallery__spot-area o-head-up">
              ...
              <div className="c-gallery__carousel">
                <div className="c-gallery__carousel__item">
                  <img src="https://mosaic03.ztat.net/vgs/media/pdp-gallery/NI/11/1A/08/4Q/12/NI111A084-Q12@13.jpg" alt="" />
                </div>
                <div className="c-gallery__carousel__item">
                  <img src="https://mosaic03.ztat.net/vgs/media/pdp-gallery/NI/11/1A/08/4Q/12/NI111A084-Q12@12.jpg" alt="" />
                </div>
                <div className="c-gallery__carousel__item">
                  <img src="https://mosaic03.ztat.net/vgs/media/pdp-gallery/NI/11/1A/08/4Q/12/NI111A084-Q12@11.jpg" alt="" />
                </div>
              </div>
            </div>
            <ul className="c-gallery__thumb-bar">
              <li className="c-gallery__thumb-bar__item is-active">
                <img src="https://mosaic03.ztat.net/vgs/media/pdp-thumb/NI/11/1A/08/4Q/12/NI111A084-Q12@13.jpg" alt="" />
              </li>
              <li className="c-gallery__thumb-bar__item">
                <img src="https://mosaic04.ztat.net/vgs/media/pdp-thumb/NI/11/1A/08/4Q/12/NI111A084-Q12@12.jpg" alt="" />
              </li>
              <li className="c-gallery__thumb-bar__item">
                <img src="https://mosaic04.ztat.net/vgs/media/pdp-thumb/NI/11/1A/08/4Q/12/NI111A084-Q12@11.jpg" alt="" />
              </li>
            </ul>
          </div>
        </div>)
