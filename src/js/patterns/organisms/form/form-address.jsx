          ...
          <form method="">
            <fieldset>
              ...
              <div className='o-form-area o-distance-m'>
                    ...
                    <li className='o-list-inline__item'>
                      <div className="o-block-short">
                        ...
                        <div className="o-block-short__body">
                          <label for="inp-radio-02" className="c-form-label">Frau</label>
                        </div>
                      </div>
                    </li>
                    <li className='o-list-inline__item'>
                      <div className="o-block-short">
                        ...
                        <div className="o-block-short__body">
                          <label for="inp-radio-02" className="c-form-label">Herr</label>
                        </div>
                      </div>
                    </li>
                  </ul>
                ...
                <div className="o-form-area__column-6-6 o-form-area__new-row">
                  <label for="inp-mail" className='c-form-label'>Street with Nr.</label>
                  <input type="text" id="inp-street" className='o-distance-s' />
                </div>
                <div className="o-form-area__column-2-6 o-form-area__new-row">
                  <label for='inp-text' className='c-form-label'>PLZ</label>
                  <input type='text' className='o-distance-s' id='inp-text' />
                </div>
                <div className="o-form-area__column-4-6">
                  <label for='inp-text' className='c-form-label'>Ort</label>
                  <input type='text' className='o-distance-s' id='inp-text' />
                </div>
                <div className="o-form-area__column-6-6 o-form-area__new-row">
                  <label for="inp-hint-address" className='c-form-label'>Hint for Address</label>
                  <input type="text" id="inp-hint-address" className="o-distance-s" />
                </div>
                <div className="o-form-area__column-6-6 o-form-area__new-row">
                  <label for="inp-hint-address" className='c-form-label'>Land</label>
            ...
            <span className="c-divider o-distance-m"></span>
