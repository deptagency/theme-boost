        ...
        <>
            <div className='m-auto md:flex md:w-11/12 text-gray-800 md:h-full-84px'>
                    ...
                    <div className='flex flex-col text-center justify-center w-64 mx-auto my-5'>
                        ...
                        <div>
                            <div className='font-bold text-2xl mb-2'>
                                ...
                                Alexandra!
                                {/* here will be instead of 'Alexandra' -> { session.account.firstName }, I suppose */}
                            </div>
                ...
                <div className='flex-auto mt-10 md:shadow-lg md:w-4/12'>
                    <button className='flex mx-auto w-5/6 sm:w-8/12 md:w-5/6 justify-between border-b pb-4 mb-6'>
                        <div className='flex'>
