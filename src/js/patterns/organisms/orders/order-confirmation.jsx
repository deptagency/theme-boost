...
class OrganismsOrderConfirmation extends Component {
    render () {
        return (
            <div>
                ...
                <span className='c-divider c-divider--break o-distance'></span>
                <section class='o-distance o-prevent-space'>
...
OrganismsOrderConfirmation.propTypes = {
}

OrganismsOrderConfirmation.defaultProps = {
}

export default ComponentInjector.return('OrganismsOrderConfirmation', OrganismsOrderConfirmation)
