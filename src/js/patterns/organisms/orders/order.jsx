            ...
            <div>
                ...
                <section className='o-distance'>
                    <div className='c-box t-quietlight'>
                        <OrganismsSummary />
                        <MoleculesButton type='primary' size='boss' className='o-distance-s'>Kostenpflichtig bestellen</MoleculesButton>
                    </div>
...
export default ComponentInjector.return('OrganismsOrder', OrganismsOrder)
