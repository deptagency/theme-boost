              ...
              <div className="o-container c-header__wrapper">
                <div className='o-list-inline o-list-inline--vertical-centered'>
                  <svg className='c-icon c-icon--s o-list-inline__item' x="0px" y="0px" viewBox="0 0 200 200">
                    <g id="Menue">
                    	<g>
                    		<path class="st0" d="M186.5,42.2h-173C6,42.2,0,36.1,0,28.7s6-13.5,13.5-13.5h173c7.5,0,13.5,6,13.5,13.5S194,42.2,186.5,42.2z"/>
                    	</g>
                    	<g>
                    		<path class="st0" d="M186.5,113.2h-173C6,113.2,0,107.1,0,99.7s6-13.5,13.5-13.5h173c7.5,0,13.5,6,13.5,13.5
                    			S194,113.2,186.5,113.2z"/>
                    	</g>
                    	<g>
                    		<path class="st0" d="M186.5,184.2h-173c-7.5,0-13.5-6-13.5-13.5s6-13.5,13.5-13.5h173c7.5,0,13.5,6,13.5,13.5
