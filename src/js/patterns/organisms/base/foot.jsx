            ...
            <Component
                ...
                <div className='o-container o-prevent-space'>
                    ...
                    <div className='c-footer__body o-grid o-grid--small-half o-grid--large-forth'>
                        <div>
                            <p className='c-category-title t-text-ghost'><FormattedMessage id='contactFooter'/></p>
                            <div className='o-distance-m'>
                                <div className='o-block-short o-block-short--centered o-footer__contact-details'>
                                    ...
                                    <div>
                                        ...
                                        <span className='u-text-s'><FormattedMessage id='serviceFooter'/></span>
                                    </div>
                                </div>
                            </div>
                            <div className='o-distance-m'>
                                <p>
                                    <span className='u-text-s'><FormattedMessage id='writeUsFooter'/></span> <br />
                                    <a href='' title='' className='c-link c-link--ghost'><strong>hallo@frontastic.cloud</strong></a>
                                </p>
                            </div>
                        </div>
                        <div className='c-footer__section'>
                            <p className='c-category-title t-text-ghost'><FormattedMessage id='paymentTermsFooter'/></p>
                        ...
                        <div className='c-footer__section'>
                            <p className='c-category-title t-text-ghost'><FormattedMessage id='companyFooter'/></p>
                            <nav className='o-distance-m'>
                                <ul className='o-list-bare'>
                                    <li className='o-list-bare__item'>
                                        <a href='' title='Über uns'><FormattedMessage id='aboutUsFooter'/></a>
                                    </li>
                                    <li className='o-list-bare__item'>
                                        <a href='' title='Partnerschaften'><FormattedMessage id='partnershipsFooter'/></a>
                                    </li>
                                    <li className='o-list-bare__item'>
                                        <a href='' title='Karriere'><FormattedMessage id='careerFooter'/></a>
                                    </li>
                                    <li className='o-list-bare__item'>
                                        <a href='' title='Presse'><FormattedMessage id='pressFooter'/></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                        <div className='c-footer__section'>
                            <p className='c-category-title t-text-ghost'><FormattedMessage id='serviceFooter'/></p>
                            <nav className='o-distance-m'>
                                <ul className='o-list-bare'>
                                    <li className='o-list-bare__item'>
                                        <a href='' title='Bestellung nachverfolgen'><FormattedMessage id='trackFooter'/></a>
                                    </li>
                                    <li className='o-list-bare__item'>
                                        <a href='' title='FAQ'><FormattedMessage id='faqFooter'/></a>
                                    </li>
                                    <li className='o-list-bare__item'>
                                        <a href='' title='Lieferung'><FormattedMessage id='deliveryFooter'/></a>
                                    </li>
                                    <li className='o-list-bare__item'>
                                        <a href='' title='Rücksendung'><FormattedMessage id='returnFooter'/></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div className='o-footer__bottom'>
                        ...
                        <nav>
                            <ul className='o-list-inline o-footer__bottom__navigation'>
                                <li className='o-list-inline__item'>
                                    <a href='' title='Jobs' className='u-text-s'><FormattedMessage id='jobsFooter'/></a>
                                </li>
                                <li className='o-list-inline__item'>
                                    <a href='' title='AGB' className='u-text-s'><FormattedMessage id='tcFooter'/></a>
                                </li>
                                <li className='o-list-inline__item'>
                                    <a href='' title='Impressum' className='u-text-s'><FormattedMessage id='imprintFooter'/></a>
                                </li>
                                <li className='o-list-inline__item'>
                                    <a href='' title='Datenschutz' className='u-text-s'><FormattedMessage id='privacyFooter'/></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
