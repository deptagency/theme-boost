        ...
        return (
            <Fragment>
                ...
                <main role='main'>
                    ...
                    <div className='o-container o-distance o-prevent-space'>
                        <div className='o-grid o-grid--medium-third'>
                            <div className='o-block-short'>
                                <svg
                                    className='o-block-short__item u-brand-color'
                                    width='24'
                                    height='24'
                                    viewBox='0 0 24 24'
                                ...
                                <strong>Lieferung in 24 Stunden</strong>
                            </div>
                            <div className='o-block-short'>
                                <svg
                                    className='o-block-short__item u-brand-color'
                    ...
                    <div className='o-container o-distance o-prevent-space'>
                        <div className='o-media-block o-media-block--compact'>
                            <div className='o-media-block__body c-box t-quietlight'>
                                <ul className='c-content-navigation'>
                                    <li className='c-content-navigation__item is-active'>
                                        <a href='' title='Beschreibung' className='c-content-navigation__anchor'>
                                            Beschreibung
                                        </a>
                                    </li>
                                    <li className='c-content-navigation__item'>
                                        <a href='' title='Produkthinweise' className='c-content-navigation__anchor'>
                                            Produkthinweise
                                        </a>
                                    </li>
                                    <li className='c-content-navigation__item'>
                                        <a href='' title='Bewertungen' className='c-content-navigation__anchor'>
                                            Bewertungen
                                        </a>
                                    </li>
                                </ul>
