            ...
            <Fragment>
                ...
                <main role='main'>
                    <div className='o-container o-distance'>
                        ...
                        <h3 class='c-title-level-3 o-distance-m o-prevent-space'>Größe</h3>
                        <div className='o-distance-s'>
                            <OrganismsSizeSwiper />
                        </div>
                        <h3 class='c-title-level-3 o-distance-m o-prevent-space'>Farbe: Olive</h3>
                        <div className='o-distance-s'>
                        ...
                        <div className='o-distance-l o-prevent-space'>
                            <div className='o-block-short'>
                                <svg class='c-icon c-icon--m o-block-short__short-item' width='36' height='30' viewBox='0 0 36 30' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <nav role='navigation' className='o-distance-m o-prevent-space'>
                        ...
                        <div className='o-distance-m'>
                            <a href='' title='' className='c-referal is-focused'>
                              ...
                              <svg class='c-icon c-referal__icon t-text-quiet' version='1.1' xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
