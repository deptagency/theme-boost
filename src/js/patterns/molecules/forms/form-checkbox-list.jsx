            ...
            <div className='c-form-element'>
                ...
                <div className='o-grid o-grid--small-half o-distance-s'>
                    ...
                    <div className='o-block-short'>
                        ...
                        <div className='o-block-short__body'>
                            <label htmlFor='inp-checkbox-02' className='c-form-label'>Nike</label>
                        </div>
                    </div>
                    <div className='o-block-short'>
                        <div className='o-block-short__short-item'>
                        ...
                        <div className='o-block-short__body'>
                            <label htmlFor='inp-checkbox-02' className='c-form-label'>Polo Ralph Lauren</label>
                        </div>
                    </div>
                    <div className='o-block-short'>
                        <div className='o-block-short__short-item'>
                        ...
                        <div className='o-block-short__body'>
                            <label htmlFor='inp-checkbox-02' className='c-form-label'>Tommy Hilfiger Denim</label>
                        </div>
                    </div>
                    <div className='o-block-short'>
                        <div className='o-block-short__short-item'>
                        ...
                        <div className='o-block-short__body'>
                            <label htmlFor='inp-checkbox-02' className='c-form-label'>Tom Tailor</label>
                        </div>
                    </div>
                </div>
            </div>
