...
<Preview withToolbar>
    <Story name='Positioning'>
        <OrganismsPromoboxWithPositioning vertical='top' horizontal='right' image={image}>
        ...
        <OrganismsPromoboxWithPositioning vertical='bottom' horizontal='left' image={{}}>
            <p className='c-topic'>Jetzt für den Sommer</p>
            <h1 className='c-title'>Viele Angebote bei Levi´s </h1>
            <Button type='primary'>
          Jetzt shoppen
        ...
        <OrganismsPromoboxWithPositioning vertical='middle' horizontal='center' image={{}}>
            <p className='c-topic'>Jetzt für den Sommer</p>
            <h1 className='c-title'>Viele Angebote bei Levi´s </h1>
            <Button type='primary'>
          Jetzt shoppen
        ...
        <OrganismsPromoboxWithPositioning image={{}}>
            <p className='c-topic'>Jetzt für den Sommer</p>
            <h1 className='c-title'>Viele Angebote bei Levi´s </h1>
            <Button type='primary'>
          Jetzt shoppen
