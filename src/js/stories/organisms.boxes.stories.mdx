...
## Featurebox
Displays a piece of information in a quiet way but gets more attention then normal content
<Preview withToolbar>
    <Story name='Featurebox'>
        <OrganismsFeaturebox description='I am a super description.' />
    </Story>
</Preview>
