...
<Meta title='1.Docs|04-Folder Structure'/>
...
### 01. Settings  
Collect the global settings of the project. The output of this not directly in CSS. **Please don't change anything here.**

File: `_settings.tokens.scss`
